...
Write-Output "$NumEtude Inot: $inotversion ;Books: $booksversion ;Synchro: $synchroversion $($svc.State) ;List Apps in GU: $Application ;Pending:$pendingupdate ;Error: $errors ";
